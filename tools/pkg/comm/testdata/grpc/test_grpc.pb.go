...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "tools/pkg/comm/testdata/grpc/test.proto",
}
...
func (c *emptyServiceClient) EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, EmptyService_EmptyCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emptyServiceClient) EmptyStream(ctx context.Context, opts ...grpc.CallOption) (EmptyService_EmptyStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &EmptyService_ServiceDesc.Streams[0], EmptyService_EmptyStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoServiceClient) EchoCall(ctx context.Context, in *Echo, opts ...grpc.CallOption) (*Echo, error) {
	out := new(Echo)
	err := c.cc.Invoke(ctx, EchoService_EchoCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
