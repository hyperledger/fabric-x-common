...
// mockery v3 takes no per-interface flags, so the local interfaces below are listed in
// .mockery.yml at the repository root and one invocation regenerates all of them.
//go:generate mockery
