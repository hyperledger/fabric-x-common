...
func (_m *IdentityDeserializer) DeserializeIdentity(serializedIdentity []byte) (msp.Identity, error) {
	...
	var r0 msp.Identity
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte) (msp.Identity, error)); ok {
		return rf(serializedIdentity)
	}
...
func (_m *IdentityDeserializer) IsWellFormed(identity *fabric_protos_go_apiv2msp.SerializedIdentity) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*fabric_protos_go_apiv2msp.SerializedIdentity) error); ok {
		r0 = rf(identity)
	} else {
		r0 = ret.Error(0)
	}
