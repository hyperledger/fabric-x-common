...
func (_m *IdentityDeserializer) DeserializeIdentity(identity *msppb.Identity) (msp.Identity, error) {
	...
	var r0 msp.Identity
	var r1 error
	if rf, ok := ret.Get(0).(func(*msppb.Identity) (msp.Identity, error)); ok {
		return rf(identity)
	}
	if rf, ok := ret.Get(0).(func(*msppb.Identity) msp.Identity); ok {
		r0 = rf(identity)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*msppb.Identity) error); ok {
		r1 = rf(identity)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IdentityDeserializer) IsWellFormed(identity *msppb.Identity) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*msppb.Identity) error); ok {
		r0 = rf(identity)
	} else {
		r0 = ret.Error(0)
	}
