...
// EvaluateIdentities provides a mock function for the type Policy
func (_mock *Policy) EvaluateIdentities(identities []msp.Identity) error {
	ret := _mock.Called(identities)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func([]msp.Identity) error); ok {
		r0 = returnFunc(identities)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_e *Policy_Expecter) EvaluateIdentities(identities any) *Policy_EvaluateIdentities_Call {
...
func (_c *Policy_EvaluateIdentities_Call) Run(run func(identities []msp.Identity)) *Policy_EvaluateIdentities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 []msp.Identity
		if args[0] != nil {
			arg0 = args[0].([]msp.Identity)
		}
		run(
			arg0,
		)
...
func (_c *Policy_EvaluateIdentities_Call) Return(err error) *Policy_EvaluateIdentities_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Policy_EvaluateIdentities_Call) RunAndReturn(run func(identities []msp.Identity) error) *Policy_EvaluateIdentities_Call {
	_c.Call.Return(run)
	return _c
}

// EvaluateSignedData provides a mock function for the type Policy
func (_mock *Policy) EvaluateSignedData(signatureSet []*protoutil.SignedData) error {
	ret := _mock.Called(signatureSet)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func([]*protoutil.SignedData) error); ok {
		r0 = returnFunc(signatureSet)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_e *Policy_Expecter) EvaluateSignedData(signatureSet any) *Policy_EvaluateSignedData_Call {
...
func (_c *Policy_EvaluateSignedData_Call) Run(run func(signatureSet []*protoutil.SignedData)) *Policy_EvaluateSignedData_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 []*protoutil.SignedData
		if args[0] != nil {
			arg0 = args[0].([]*protoutil.SignedData)
		}
		run(
			arg0,
		)
...
func (_c *Policy_EvaluateSignedData_Call) Return(err error) *Policy_EvaluateSignedData_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Policy_EvaluateSignedData_Call) RunAndReturn(run func(signatureSet []*protoutil.SignedData) error) *Policy_EvaluateSignedData_Call {
	_c.Call.Return(run)
	return _c
}
