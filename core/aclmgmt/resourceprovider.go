...
func (rp *resourceProvider) enforceDefaultBehavior(resName, _ string, _ any) bool {
...
func (rp *resourceProvider) CheckACL(resName, channelID string, idinfo any) error {
