...
type ConfigUpdateEnvelope struct {
	*protocommon.ConfigUpdateEnvelope
}
...
func (cue *ConfigUpdateEnvelope) StaticallyOpaqueFieldProto(name string) (proto.Message, error) {
	...
	return &protocommon.ConfigUpdate{}, nil
}

type ConfigSignature struct{ *protocommon.ConfigSignature }
...
type Config struct{ *protocommon.Config }
...
type ConfigUpdate struct{ *protocommon.ConfigUpdate }
