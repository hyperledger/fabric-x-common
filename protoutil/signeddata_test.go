...
func TestConfigEnvelopeAsSignedData(t *testing.T) {
	...
	identities := []*applicationpb.Identity{
		applicationpb.NewIdentityWithCertificate("org1", []byte("Identity1")),
		applicationpb.NewIdentityWithCertificate("org2", []byte("Identity2")),
	}
...
func TestEnvelopeAsSignedData(t *testing.T) {
	identity := applicationpb.NewIdentityWithCertificate("org1", []byte("Identity1"))
	sig := []byte("Bar")
...
func TestLogMessageForIdentity(t *testing.T) {
	...
	id := applicationpb.NewIdentityWithCertificate("MyMSP", pem)
