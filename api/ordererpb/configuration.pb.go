...
var file_api_ordererpb_configuration_proto_rawDesc = []byte{
	0x0a, 0x21, 0x61, 0x70, 0x69, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x65, 0x72, 0x70, 0x62, 0x2f,
	...
	0x6f, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x36,
	...
	0x78, 0x2d, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x65, 0x72, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_api_ordererpb_configuration_proto_rawDescOnce sync.Once
	file_api_ordererpb_configuration_proto_rawDescData = file_api_ordererpb_configuration_proto_rawDesc
)

func file_api_ordererpb_configuration_proto_rawDescGZIP() []byte {
	file_api_ordererpb_configuration_proto_rawDescOnce.Do(func() {
		file_api_ordererpb_configuration_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_ordererpb_configuration_proto_rawDescData)
	})
...
var file_api_ordererpb_configuration_proto_goTypes = []interface{}{
...
func file_api_ordererpb_configuration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_ordererpb_configuration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_ordererpb_configuration_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_ordererpb_configuration_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_ordererpb_configuration_proto_rawDesc = nil
