...
const (
	AtomicBroadcast_Broadcast_FullMethodName = "/protoorderer.AtomicBroadcast/Broadcast"
	AtomicBroadcast_Deliver_FullMethodName   = "/protoorderer.AtomicBroadcast/Deliver"
)
...
func (c *atomicBroadcastClient) Broadcast(ctx context.Context, opts ...grpc.CallOption) (AtomicBroadcast_BroadcastClient, error) {
	stream, err := c.cc.NewStream(ctx, &AtomicBroadcast_ServiceDesc.Streams[0], AtomicBroadcast_Broadcast_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type AtomicBroadcast_BroadcastClient interface {
	Send(*protocommon.Envelope) error
...
func (x *atomicBroadcastBroadcastClient) Send(m *protocommon.Envelope) error {
...
func (c *atomicBroadcastClient) Deliver(ctx context.Context, opts ...grpc.CallOption) (AtomicBroadcast_DeliverClient, error) {
	stream, err := c.cc.NewStream(ctx, &AtomicBroadcast_ServiceDesc.Streams[1], AtomicBroadcast_Deliver_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *atomicBroadcastDeliverClient) Send(m *protocommon.Envelope) error {
	return x.ClientStream.SendMsg(m)
}
...
type AtomicBroadcast_BroadcastServer interface {
	...
	Recv() (*protocommon.Envelope, error)
	grpc.ServerStream
}
...
func (x *atomicBroadcastBroadcastServer) Recv() (*protocommon.Envelope, error) {
	m := new(protocommon.Envelope)
...
func (x *atomicBroadcastDeliverServer) Recv() (*protocommon.Envelope, error) {
	m := new(protocommon.Envelope)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var AtomicBroadcast_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protoorderer.AtomicBroadcast",
	...
	Metadata: "api/protoorderer/ab.proto",
}
