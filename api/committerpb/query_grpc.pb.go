...
func (c *queryServiceClient) GetNamespacePolicies(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*applicationpb.NamespacePolicies, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_GetNamespacePolicies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) GetConfigTransaction(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*applicationpb.ConfigTransaction, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_GetConfigTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServiceServer) BeginView(context.Context, *ViewParameters) (*View, error) {
	return nil, status.Error(codes.Unimplemented, "method BeginView not implemented")
}
func (UnimplementedQueryServiceServer) EndView(context.Context, *View) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method EndView not implemented")
}
