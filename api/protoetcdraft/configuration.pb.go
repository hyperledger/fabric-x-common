...
// 	protoc        v5.29.3
// source: api/protoetcdraft/configuration.proto

package protoetcdraft
...
func (x *ConfigMetadata) Reset() {
	*x = ConfigMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protoetcdraft_configuration_proto_msgTypes[0]
...
func (*ConfigMetadata) Descriptor() ([]byte, []int) {
	return file_api_protoetcdraft_configuration_proto_rawDescGZIP(), []int{0}
}
...
func (x *Consenter) Reset() {
	*x = Consenter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protoetcdraft_configuration_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Consenter) Descriptor() ([]byte, []int) {
	return file_api_protoetcdraft_configuration_proto_rawDescGZIP(), []int{1}
}
...
func (x *Options) Reset() {
	*x = Options{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protoetcdraft_configuration_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Options) Descriptor() ([]byte, []int) {
	return file_api_protoetcdraft_configuration_proto_rawDescGZIP(), []int{2}
}
...
var File_api_protoetcdraft_configuration_proto protoreflect.FileDescriptor

var file_api_protoetcdraft_configuration_proto_rawDesc = []byte{
	,
	...
	0x74, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x3a, 0x5a,
	...
	0x6f, 0x65, 0x74, 0x63, 0x64, 0x72, 0x61, 0x66, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_api_protoetcdraft_configuration_proto_rawDescOnce sync.Once
	file_api_protoetcdraft_configuration_proto_rawDescData = file_api_protoetcdraft_configuration_proto_rawDesc
)

func file_api_protoetcdraft_configuration_proto_rawDescGZIP() []byte {
	file_api_protoetcdraft_configuration_proto_rawDescOnce.Do(func() {
		file_api_protoetcdraft_configuration_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_protoetcdraft_configuration_proto_rawDescData)
	})
	return file_api_protoetcdraft_configuration_proto_rawDescData
}

var file_api_protoetcdraft_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_protoetcdraft_configuration_proto_goTypes = []interface{}{
	(*ConfigMetadata)(nil), // 0: protoetcdraft.ConfigMetadata
	(*Consenter)(nil),      // 1: protoetcdraft.Consenter
	(*Options)(nil),        // 2: protoetcdraft.Options
}
var file_api_protoetcdraft_configuration_proto_depIdxs = []int32{
	1, // 0: protoetcdraft.ConfigMetadata.consenters:type_name -> protoetcdraft.Consenter
	2, // 1: protoetcdraft.ConfigMetadata.options:type_name -> protoetcdraft.Options
...
func init() { file_api_protoetcdraft_configuration_proto_init() }
func file_api_protoetcdraft_configuration_proto_init() {
	if File_api_protoetcdraft_configuration_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_protoetcdraft_configuration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protoetcdraft_configuration_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protoetcdraft_configuration_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_protoetcdraft_configuration_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_protoetcdraft_configuration_proto_goTypes,
		DependencyIndexes: file_api_protoetcdraft_configuration_proto_depIdxs,
		MessageInfos:      file_api_protoetcdraft_configuration_proto_msgTypes,
	}.Build()
	File_api_protoetcdraft_configuration_proto = out.File
	file_api_protoetcdraft_configuration_proto_rawDesc = nil
	file_api_protoetcdraft_configuration_proto_goTypes = nil
	file_api_protoetcdraft_configuration_proto_depIdxs = nil
}
