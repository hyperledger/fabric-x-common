...
// 	protoc        v5.29.3
// source: api/protocommon/configuration.proto
...
func (x *HashingAlgorithm) Reset() {
	*x = HashingAlgorithm{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[0]
...
func (*HashingAlgorithm) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{0}
}
...
func (x *BlockDataHashingStructure) Reset() {
	*x = BlockDataHashingStructure{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlockDataHashingStructure) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{1}
}
...
func (x *OrdererAddresses) Reset() {
	*x = OrdererAddresses{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrdererAddresses) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{2}
}
...
func (x *Consenter) Reset() {
	*x = Consenter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Consenter) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{3}
}
...
func (x *Orderers) Reset() {
	*x = Orderers{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Orderers) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{4}
}
...
func (x *Consortium) Reset() {
	*x = Consortium{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Consortium) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{5}
}
...
func (x *Capabilities) Reset() {
	*x = Capabilities{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Capabilities) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{6}
}
...
func (x *Capability) Reset() {
	*x = Capability{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_protocommon_configuration_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Capability) Descriptor() ([]byte, []int) {
	return file_api_protocommon_configuration_proto_rawDescGZIP(), []int{7}
}

var File_api_protocommon_configuration_proto protoreflect.FileDescriptor

var file_api_protocommon_configuration_proto_rawDesc = []byte{
	,
	...
	0xc6, 0x01, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x0c, 0x0a, 0x0a, 0x43, 0x61, 0x70, 0x61, 0x62,
	0x69, 0x6c, 0x69, 0x74, 0x79, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_api_protocommon_configuration_proto_rawDescOnce sync.Once
	file_api_protocommon_configuration_proto_rawDescData = file_api_protocommon_configuration_proto_rawDesc
)

func file_api_protocommon_configuration_proto_rawDescGZIP() []byte {
	file_api_protocommon_configuration_proto_rawDescOnce.Do(func() {
		file_api_protocommon_configuration_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_protocommon_configuration_proto_rawDescData)
	})
	return file_api_protocommon_configuration_proto_rawDescData
}

var file_api_protocommon_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_api_protocommon_configuration_proto_goTypes = []interface{}{
	(*HashingAlgorithm)(nil),          // 0: protocommon.HashingAlgorithm
	(*BlockDataHashingStructure)(nil), // 1: protocommon.BlockDataHashingStructure
	(*OrdererAddresses)(nil),          // 2: protocommon.OrdererAddresses
	(*Consenter)(nil),                 // 3: protocommon.Consenter
	(*Orderers)(nil),                  // 4: protocommon.Orderers
	(*Consortium)(nil),                // 5: protocommon.Consortium
	(*Capabilities)(nil),              // 6: protocommon.Capabilities
	(*Capability)(nil),                // 7: protocommon.Capability
	nil,                               // 8: protocommon.Capabilities.CapabilitiesEntry
}
var file_api_protocommon_configuration_proto_depIdxs = []int32{
	3, // 0: protocommon.Orderers.consenter_mapping:type_name -> protocommon.Consenter
	8, // 1: protocommon.Capabilities.capabilities:type_name -> protocommon.Capabilities.CapabilitiesEntry
	7, // 2: protocommon.Capabilities.CapabilitiesEntry.value:type_name -> protocommon.Capability
...
func init() { file_api_protocommon_configuration_proto_init() }
func file_api_protocommon_configuration_proto_init() {
	if File_api_protocommon_configuration_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_protocommon_configuration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_protocommon_configuration_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_protocommon_configuration_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_protocommon_configuration_proto_goTypes,
		DependencyIndexes: file_api_protocommon_configuration_proto_depIdxs,
		MessageInfos:      file_api_protocommon_configuration_proto_msgTypes,
	}.Build()
	File_api_protocommon_configuration_proto = out.File
	file_api_protocommon_configuration_proto_rawDesc = nil
	file_api_protocommon_configuration_proto_goTypes = nil
	file_api_protocommon_configuration_proto_depIdxs = nil
}
