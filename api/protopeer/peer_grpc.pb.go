...
const (
	Endorser_ProcessProposal_FullMethodName = "/protopeer.Endorser/ProcessProposal"
)
...
func (c *endorserClient) ProcessProposal(ctx context.Context, in *SignedProposal, opts ...grpc.CallOption) (*ProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, Endorser_ProcessProposal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Endorser_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protopeer.Endorser",
	...
	Metadata: "api/protopeer/peer.proto",
}
